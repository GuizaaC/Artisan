...
<body>
    ...
    <br> <br><br>
    <div class="container">
        <form id="formSalvar" action="salvar.php" method="POST" enctype="multipart/form-data">
            <!-- Campo nome -->
            ...
            <input class="entrada" type="tel" maxlength="13" name="telefone_usuario" id="telefone_usuario" placeholder="(00)90000-0000" required> <br>
            
            <!-- Campo CPF -->
            <label class="titulo">CPF</label> <br>
            <input class="entrada" maxlength="14" name="cpf_usuario" id="cpf_usuario" placeholder="000.000.000-00" required> <br>
