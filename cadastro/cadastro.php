...
<br> <br><br>
    ...
    <form id="formSalvar" action='salvar.php' method="POST" enctype = "multipart/form-data" onsubmit>
            ...
            <label class="titulo">Telefone</label> <br>
                <input class="entrada" type="tel" max="20"name='Telefone_Cliente' id="Telefone_Cliente" placeholder="(00)90000-0000" required> <br>
            <!-- Campo CPF -->
            <label class="titulo">CPF</label> <br>
                <input class="entrada" min="20" max="20"name='Cpf_Cliente' id="CPF_Cliente" placeholder="000.000.000-00" required > <br>
